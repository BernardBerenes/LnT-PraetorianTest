...
<body>
    ...
    <h1 class="m-5">Edit Category</h1>
    <form class="m-5" method="POST" action="{{ route('update_category', ['id'=>$category->id]) }}">
        @csrf
        @method('PATCH')
        <div class="mb-3">
            <label for="category-name" class="form-label">Category Name</label>
            <input type="text" class="form-control" id="category-name" name="category" value="{{$category->category_name}}">
            @error('category')
